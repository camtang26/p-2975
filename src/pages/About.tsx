...
import { DesktopAboutHero } from "@/components/about/desktop/DesktopAboutHero";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black relative overflow-hidden">
      ...
      <main className="relative flex-grow z-10">
        {isMobile ? (
          <div className="container mx-auto px-3 md:px-10 pt-24 md:pt-40">
        ...
        {/* Rest of the content */}
        <div className="container mx-auto px-3 md:px-10 pb-8 md:pb-32">
          <div className="max-w-7xl mx-auto">

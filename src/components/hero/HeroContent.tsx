  ...
  return (
    <div className="relative z-[2] flex flex-col items-center justify-center text-center space-y-8 max-w-4xl mx-auto px-4">
      <h1 className="font-inter text-7xl md:text-8xl font-bold tracking-[-0.02em] animate-fade-in">
        <span className="bg-gradient-to-r from-[#222]/50 from-5% via-blue-400/50 via-orange-400/50 via-cyan-300/50 via-red-400/50 to-purple-400/50 bg-clip-text text-transparent inline-block [text-shadow:0_0_20px_rgba(0,0,0,0.9),0_0_35px_rgba(0,0,0,0.7),0_0_50px_rgba(0,0,0,0.4),0_4px_8px_rgba(0,0,0,0.8)] hover:scale-105 transition-transform duration-300">
          Cre8tive AI
        </span>
      </h1>

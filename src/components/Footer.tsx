          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12">
            <div className="space-y-2 md:space-y-4">
              ...
              <div className="flex space-x-3 md:space-x-4" role="list" aria-label="Social media links">
                ...
                >
                  <Instagram className="w-3.5 h-3.5 md:w-5 md:h-5 text-white/70 hover:text-white transition-colors duration-300 cursor-pointer" />
                </a>
                <a 
                  ...
                  aria-label="Youtube"
                >
                  <Youtube className="w-3.5 h-3.5 md:w-5 md:h-5 text-white/70 hover:text-white transition-colors duration-300 cursor-pointer" />
                </a>
                <a 
                  ...
                  aria-label="LinkedIn"
                >
                  <Linkedin className="w-3.5 h-3.5 md:w-5 md:h-5 text-white/70 hover:text-white transition-colors duration-300 cursor-pointer" />
                </a>
              </div>
            </div>
            ...
            <nav aria-label="About navigation">
              ...
              <ul className="space-y-1 md:space-y-2" role="list">
                ...
                <li>
                  <Link to="/terms" className="font-geist text-xs md:text-base text-white/70 hover:text-white transition-colors duration-300">
                    Terms of Service
                  </Link>
                </li>
                <li>

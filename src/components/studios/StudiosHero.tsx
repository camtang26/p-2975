  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center mt-4">
        <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 text-white [text-shadow:0_0_15px_rgba(255,255,255,0.5),0_0_25px_rgba(255,255,255,0.3)]">
          Cre8tive AI Studios
        </h1>
        
        <p className="text-2xl md:text-3xl lg:text-4xl text-white max-w-4xl mx-auto mb-8 italic [text-shadow:0_0_15px_rgba(255,255,255,0.5),0_0_25px_rgba(255,255,255,0.3)]">

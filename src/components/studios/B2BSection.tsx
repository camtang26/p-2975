    ...
    <section className="py-12 md:py-24 relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <ScrollFade delay={200}>
          <p className="text-lg md:text-xl text-white/90 text-center max-w-4xl mx-auto mb-8 md:mb-16 [text-shadow:0_0_10px_rgba(255,255,255,0.4),0_0_20px_rgba(255,255,255,0.2)]">
        ...
        <ScrollFade delay={500}>
          <p className="text-lg md:text-xl text-white/90 text-center max-w-4xl mx-auto mt-8 md:mt-12 mb-4 md:mb-8 [text-shadow:0_0_10px_rgba(255,255,255,0.4),0_0_20px_rgba(255,255,255,0.2)]">

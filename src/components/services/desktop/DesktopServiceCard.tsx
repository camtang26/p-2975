    ...
    >
      <div 
        className={cn(
          ...
          "flex flex-col items-center justify-center text-center p-4 md:p-16"
        )}
        style={{
          '--service-color': color,
      ...
      >
        <div className="relative group-hover:animate-pulse mb-4 md:mb-10">
          <Icon 
            className="w-12 h-12 md:w-28 md:h-28 transition-all duration-300 drop-shadow-[0_0_15px_var(--service-color)] group-hover:drop-shadow-[0_0_30px_var(--service-color)]"
            style={{ color: color }}
          />
        </div>
        ...
        <h3 
          ...
          className="text-2xl md:text-4xl mb-3 md:mb-6 font-semibold bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent leading-tight"
        >
          {title}
        </h3>
        
        <p className="text-lg md:text-xl mb-4 md:mb-8 text-white/80 leading-relaxed">
          {description}
        </p>
        ...
        <div className="text-center relative z-10">
          <Link 
            ...
            className={cn(
              ...
              "cursor-pointer py-2 px-4 text-base md:text-lg"
            )}

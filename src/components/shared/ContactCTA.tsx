    ...
    <section className="py-16 md:py-32 relative overflow-hidden">
      ...
      <div className="container relative mx-auto px-6 z-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <ScrollFade>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gradient mb-4 md:mb-6 font-geist neon-glow">
              Contact Us
            </h2>
          </ScrollFade>
          
          <ScrollFade delay={100}>
            <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-gradient mb-4 md:mb-8 font-geist neon-glow">
              Don't get left behind—AI is transforming businesses now.
            </h3>
          </ScrollFade>
          
          <ScrollFade delay={200}>
            <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4 md:mb-8 neon-glow">
          ...
          <ScrollFade delay={300}>
            <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed neon-glow">

      ...
      className={`relative flex items-center justify-center overflow-hidden ${
        isMobile 
          ...
          : 'max-w-[2560px] mx-auto ' + // Base desktop styles
            ...
            'lg:h-[110vh] lg:min-h-[800px]' // 1920x1080 specific - increased height
      }`}
    >
      ...
      <div className={`container mx-auto px-4 text-center relative ${
        isMobile 
          ...
          : 'max-w-[1200px] ' + // Base desktop container
            ...
            'lg:pt-36 lg:max-w-[1100px]' // 1920x1080 specific - shifted down and decreased width
      }`}>
        <motion.h1 
          ...
          className={`font-extrabold text-white neon-glow ${
            isMobile 
              ? 'text-4xl mt-2 mb-3' 
              : 'text-5xl lg:text-5xl 2xl:text-8xl xl:text-7xl mb-6' // Decreased text size for 1920x1080
          }`}
        >
        ...
        <motion.p 
          ...
          className={`text-white/90 font-semibold max-w-3xl mx-auto neon-glow-subtle ${
            isMobile 
              ...
              : 'text-xl lg:text-xl 2xl:text-4xl xl:text-3xl mb-8' // Decreased text size for 1920x1080
          }`}
        >
        ...
        >
          <div className={`mx-auto text-center ${
            isMobile 
              ? 'max-w-[95%] space-y-1' 
              : 'max-w-2xl 2xl:max-w-3xl lg:max-w-2xl' // Decreased width for 1920x1080
          }`}>
            <h3 className={`font-bold text-white neon-glow ${
              isMobile 
                ? 'text-xl mb-2' 
                : 'text-2xl lg:text-2xl 2xl:text-5xl xl:text-4xl mb-4' // Decreased text size for 1920x1080
            }`}>
            ...
            <p className={`text-white/80 neon-glow-subtle ${
              isMobile 
                ...
                : 'text-lg lg:text-lg 2xl:text-3xl xl:text-2xl mb-6' // Decreased text size for 1920x1080
            }`}>
              ...
              className={`absolute text-white/80 ${
                isMobile 
                  ...
                  : 'bottom-[-80px] right-[80px] ' + // Default position
                    ...
                    'lg:bottom-[-90px] lg:right-[90px]' // 1920x1080 specific - adjusted position
              }`}
              animate={{ 
                x: [0, 10, 0],
                y: [0, 10, 0],
            ...
            >
              <ArrowDownRight className={isMobile ? "w-10 h-10" : "w-16 h-16 2xl:w-20 2xl:h-20 lg:w-14 lg:h-14"} />
            </motion.div>
          </div>
        </motion.div>
      </div>

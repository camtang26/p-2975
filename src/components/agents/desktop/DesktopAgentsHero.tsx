...
export const DesktopAgentsHero = () => {
  return (
    <section 
    ...
    >
      ...
      <div className="relative z-20 mt-[-12rem]">
        <div className="flex flex-col items-center justify-center text-center space-y-8 max-w-5xl mx-auto px-4">
          <h1 className="font-inter text-7xl font-bold tracking-[-0.02em] text-white neon-glow opacity-0 animate-[fadeIn_3s_ease-out_0.5s_forwards]">
            AI Autonomous Agents
          </h1>
          <p className="font-inter text-2xl font-medium tracking-[-0.01em] text-white/90 neon-glow-subtle opacity-0 animate-[fadeIn_3s_ease-out_1s_forwards]">
